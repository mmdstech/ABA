...
|--------------|-------------------|
| **Hotel**    | $\theta_{\text{hotel}} \sim \text{Beta}(287.35,\ 374.65)$<br>$\mathbb{P}(0.41 \leq \theta_{\text{hotel}} \leq 0.47) \approx 0.95$ |
| **Resort**   | $\theta_{\text{resort}} \sim \text{Beta}(92,\ 291)$<br>$\mathbb{P}(0.21 \leq \theta_{\text{resort}} \leq 0.28) \approx 0.95$ |
